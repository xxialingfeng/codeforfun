...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
       ...
       if(o.getClass() != this.getClass()){ //返回Class类型的对象
           return false;
       }
       SimpleOomage that = (SimpleOomage) o; //o是Object，所以需要cast
       return (this.red == that.red) && (this.blue == that.blue) && (this.green == that.green);
    }


    @Override
    public int hashCode() { //当重写了equals方法时，一般需要重写hashCode()方法，因为之前的方法获取的是内存地址
        if (!USE_PERFECT_HASH) {
